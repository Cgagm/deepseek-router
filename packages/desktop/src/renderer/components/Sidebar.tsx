  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        <div className="sidebar-brand" onClick={handleNewChat} style={{ cursor: 'pointer', WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        ...
        <button
          ...
          title={t('new_chat')}
          style={{ background: 'var(--accent-subtle)', color: 'var(--accent-primary)', borderRadius: 'var(--radius-md)', width: 32, height: 32, fontWeight: 700, fontSize: 18, WebkitAppRegion: 'no-drag' } as React.CSSProperties}
        >
          +
        </button>
      </div>
